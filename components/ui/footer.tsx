      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li className="ml-4">
              <a href="http://github.com/interwallet" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; InterWallet.xyz. All rights reserved.</div>
